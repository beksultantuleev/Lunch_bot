...
customer_button = InlineKeyboardButton(
    text="I'm a customer", callback_data=StartCallbackData(action=customer_action).pack())

administrator_button = InlineKeyboardButton(
    text="I'm an administrator", callback_data=StartCallbackData(action=administrator_action).pack())

start_keyboard = InlineKeyboardMarkup(
    inline_keyboard=[[customer_button, administrator_button]])

main_menu_button = InlineKeyboardButton(
    text="Main menu", callback_data=StartCallbackData(action=return_main_menu_action).pack())

# CUSTOMERS options
order_lunch_btn = InlineKeyboardButton(
    text="Order a lunch", callback_data=StartCallbackData(action=order_lunch_action).pack())
order_additional_stuff_btn = InlineKeyboardButton(
    text="Order baked goodies", callback_data=StartCallbackData(action=order_additional_stuff_action).pack())
my_orders_btn = InlineKeyboardButton(
    text="My orders", callback_data=StartCallbackData(action=my_orders_action).pack())

lunch_rating_list_btn = InlineKeyboardButton(
    text="Lunch rating list", callback_data=StartCallbackData(action=lunch_rating_list_action).pack())

rate_your_lunch_btn = InlineKeyboardButton(
    text="Rate your lunch", callback_data=StartCallbackData(action=rate_your_lunch_action).pack())


leave_review_btn = InlineKeyboardButton(
    text="Leave a review", callback_data=StartCallbackData(action=leave_review_action).pack())
...
current_lunch_menu_btn = InlineKeyboardButton(
    text="Current Lunch Menu", callback_data=StartCallbackData(action=current_lunch_menu_action).pack())
current_bakery_menu_btn = InlineKeyboardButton(
    text="Current Bakery Menu", callback_data=StartCallbackData(action=current_bakekry_action).pack())

edit_lunch_menu_btn = InlineKeyboardButton(
    text="Edit Lunch Menu", callback_data=StartCallbackData(action=edit_lunch_menu_action).pack())

edit_bakery_menu_btn = InlineKeyboardButton(
    text="Edit Bakery Menu", callback_data=StartCallbackData(action=edit_bakekry_action).pack())


main_menu_commissioner_keyboard = InlineKeyboardMarkup(inline_keyboard=[
